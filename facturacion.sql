...
--
-- Servidor: localhost
-- Tiempo de generación: 08-04-2016 a las 07:52:49
...
--
CREATE DATABASE `escuela` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `escuela`;
...
CREATE TABLE IF NOT EXISTS `clientes` (
  `idClientes` varchar(12) NOT NULL,
...
INSERT INTO `clientes` (`idClientes`, `nombres`, `apellidos`, `direccion`, `telefono`, `fecha_nacimiento`, `identificacion`, `ciudad`, `fecha_ingreso`) VALUES
('1', 'Luis Fernando', 'Prudencio Cruz', 'Otzolotepec', '9514394734', '2016-04-01', 3, 3, '2016-04-08'),
('2', 'Monserrat', 'Merino Prudencio', 'Xoxocotlan', '', '2016-04-04', 4, 0, '2016-04-08');
...
INSERT INTO `productos` (`idProducto`, `descripcion`, `precio`, `idIva`, `notas`) VALUES
('1', 'Coca-Cola', 890, 1, 'Excelente sabor'),
('2', 'Corona', 12000, 2, 'Bien frias');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  `idUsuarioss` varchar(10) NOT NULL,
  `nombres` varchar(30) NOT NULL,
  `apellidos` varchar(30) NOT NULL,
...
INSERT INTO `usuarios` (`idUsuarioss`, `nombres`, `apellidos`, `clave`, `idPerfil`) VALUES
('Luis', 'Luis Fernando', 'Prudencio Cruz', '123', 1),
('Monse', 'Monserrat', 'Merino Prudencio', '123', 2);
--
...
(NULL, 'escuela', 'estudiantes', 'matricula', 1, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'escuela', 'estudiantes', 'nombre', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'escuela', 'estudiantes', 'direccion', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'escuela', 'estudiantes', 'telefono', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'idClientes', 1, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'nombres', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'apellidos', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'direccion', 4, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'telefono', 5, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'fecha_nacimiento', 6, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'identificacion', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'ciudad', 8, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'clientes', 'fecha_ingreso', 9, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'detallefactura', 'idFactura', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'detallefactura', 'idLinea', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'detallefactura', 'idProducto', 3, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'detallefactura', 'descripcion', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'detallefactura', 'precio', 5, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'detallefactura', 'cantidadProductos', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'facturas', 'idFactura', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'facturas', 'idCliente', 2, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'facturas', 'fecha', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'productos', 'idProducto', 1, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'productos', 'descripcion', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'productos', 'precio', 3, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'productos', 'idIva', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'productos', 'notas', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'usuarios', 'idUsuarioss', 1, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'usuarios', 'nombres', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'usuarios', 'apellidos', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'usuarios', 'clave', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'facturacion', 'usuarios', 'idPerfil', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'boleto', 'idBoleto', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'boleto', 'Precio', 2, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'boleto', 'Base', 3, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'boleto', 'Destino', 4, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'idCamionetas', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'N°_Camioneta', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Hora_que_paso', 3, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Num_pasajeros', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Base_tepos', 5, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Total_pasajeros', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Paquete', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Taquillera', 8, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Nom_conductor', 9, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Pasajeros_idPasajeros', 10, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'camionetas', 'Pasajeros_Boleto_idBoleto', 11, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'pasajeros', 'idPasajeros', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'pasajeros', 'Nombre(s)', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'pasajeros', 'Apellidos', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mydb', 'pasajeros', 'Boleto_idBoleto', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '212'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '2267'),
('UPTIME_SINCE_FLUSH_STATUS', '2267');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.36\\data\\Luis-PC.pid'),
('QUERY_CACHE_SIZE', '0'),
('PROFILING', 'OFF'),
('HAVE_INNODB', 'YES'),
('THREAD_STACK', '196608'),
...
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.36\\data\\Luis-PC.log'),
('SSL_CERT', ''),
('HOSTNAME', 'Luis-PC'),
...
('SYSTEM_TIME_ZONE', 'Hora de verano central (M'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.36\\data\\Luis-PC-slow.log'),
...
(NULL, 'facturacion', 'PRIMARY', NULL, 'facturacion', 'detallefactura', 'idFactura', 1, NULL, NULL, NULL, NULL),
(NULL, 'facturacion', 'PRIMARY', NULL, 'facturacion', 'detallefactura', 'idLinea', 2, NULL, NULL, NULL, NULL),
(NULL, 'facturacion', 'PRIMARY', NULL, 'facturacion', 'facturas', 'idFactura', 1, NULL, NULL, NULL, NULL),
(NULL, 'facturacion', 'PRIMARY', NULL, 'facturacion', 'productos', 'idProducto', 1, NULL, NULL, NULL, NULL),
(NULL, 'facturacion', 'PRIMARY', NULL, 'facturacion', 'usuarios', 'idUsuarioss', 1, NULL, NULL, NULL, NULL),
(NULL, 'mydb', 'PRIMARY', NULL, 'mydb', 'boleto', 'idBoleto', 1, NULL, NULL, NULL, NULL),
(NULL, 'mydb', 'PRIMARY', NULL, 'mydb', 'camionetas', 'idCamionetas', 1, NULL, NULL, NULL, NULL),
(NULL, 'mydb', 'PRIMARY', NULL, 'mydb', 'camionetas', 'Pasajeros_idPasajeros', 2, NULL, NULL, NULL, NULL),
(NULL, 'mydb', 'PRIMARY', NULL, 'mydb', 'camionetas', 'Pasajeros_Boleto_idBoleto', 3, NULL, NULL, NULL, NULL),
(NULL, 'mydb', 'fk_Camionetas_Pasajeros1', NULL, 'mydb', 'camionetas', 'Pasajeros_idPasajeros', 1, 1, 'mydb', 'pasajeros', 'idPasajeros'),
(NULL, 'mydb', 'fk_Camionetas_Pasajeros1', NULL, 'mydb', 'camionetas', 'Pasajeros_Boleto_idBoleto', 2, 2, 'mydb', 'pasajeros', 'Boleto_idBoleto'),
(NULL, 'mydb', 'PRIMARY', NULL, 'mydb', 'pasajeros', 'idPasajeros', 1, NULL, NULL, NULL, NULL),
(NULL, 'mydb', 'PRIMARY', NULL, 'mydb', 'pasajeros', 'Boleto_idBoleto', 2, NULL, NULL, NULL, NULL),
(NULL, 'mydb', 'fk_Pasajeros_Boleto', NULL, 'mydb', 'pasajeros', 'Boleto_idBoleto', 1, 1, 'mydb', 'boleto', 'idBoleto'),
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, NULL, '', '', NULL),
(NULL, 'escuela', 'estudiantes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-03-15 15:40:38', '2016-03-15 16:40:38', NULL, NULL, '', '', NULL),
(NULL, 'facturacion', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 66, 132, 281474976710655, 1024, 0, '2016-04-08 02:37:58', '2016-04-08 02:41:20', NULL, NULL, '', '', NULL),
(NULL, 'facturacion', 'detallefactura', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:50:29', '2016-04-08 02:50:29', NULL, NULL, '', '', NULL),
(NULL, 'facturacion', 'facturas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-04-08 02:46:19', '2016-04-08 02:46:19', NULL, NULL, '', '', NULL),
(NULL, 'facturacion', 'productos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 44, 88, 281474976710655, 2048, 0, '2016-04-08 02:26:56', '2016-04-08 02:28:53', NULL, NULL, '', '', NULL),
(NULL, 'facturacion', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 48, 96, 281474976710655, 2048, 0, '2016-04-08 02:22:26', '2016-04-08 02:24:15', NULL, NULL, '', '', NULL),
(NULL, 'mydb', 'boleto', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2016-04-05 10:19:44', NULL, NULL, NULL, '', '', NULL),
(NULL, 'mydb', 'camionetas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2016-04-05 10:19:44', NULL, NULL, NULL, '', '', NULL),
(NULL, 'mydb', 'pasajeros', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2016-04-05 10:19:44', NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:32', '2008-11-14 11:31:32', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 450, 197, 88650, 55450570411999231, 16384, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 975, 9, 8775, 2533274790395903, 16384, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 497, 812, 403852, 281474976710655, 20480, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 152, 281474976710655, 2048, 48, '2008-11-14 11:31:31', '2009-03-06 19:08:32', NULL, NULL, '', '', NULL);
...
(69, 'root', 'localhost:57481', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'mydb', 'fk_Camionetas_Pasajeros1', NULL, 'mydb', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'camionetas', 'pasajeros'),
(NULL, 'mydb', 'fk_Pasajeros_Boleto', NULL, 'mydb', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'pasajeros', 'boleto');
...
(NULL, 'escuela', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'facturacion', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '714'),
...
(NULL, 'facturacion', 'detallefactura', 0, 'facturacion', 'PRIMARY', 1, 'idFactura', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'facturacion', 'detallefactura', 0, 'facturacion', 'PRIMARY', 2, 'idLinea', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'facturacion', 'facturas', 0, 'facturacion', 'PRIMARY', 1, 'idFactura', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'facturacion', 'productos', 0, 'facturacion', 'PRIMARY', 1, 'idProducto', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'facturacion', 'usuarios', 0, 'facturacion', 'PRIMARY', 1, 'idUsuarioss', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'boleto', 0, 'mydb', 'PRIMARY', 1, 'idBoleto', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'camionetas', 0, 'mydb', 'PRIMARY', 1, 'idCamionetas', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'camionetas', 0, 'mydb', 'PRIMARY', 2, 'Pasajeros_idPasajeros', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'camionetas', 0, 'mydb', 'PRIMARY', 3, 'Pasajeros_Boleto_idBoleto', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'camionetas', 1, 'mydb', 'fk_Camionetas_Pasajeros1_idx', 1, 'Pasajeros_idPasajeros', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'camionetas', 1, 'mydb', 'fk_Camionetas_Pasajeros1_idx', 2, 'Pasajeros_Boleto_idBoleto', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'pasajeros', 0, 'mydb', 'PRIMARY', 1, 'idPasajeros', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'pasajeros', 0, 'mydb', 'PRIMARY', 2, 'Boleto_idBoleto', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mydb', 'pasajeros', 1, 'mydb', 'fk_Pasajeros_Boleto_idx', 1, 'Boleto_idBoleto', 'A', 0, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:52:50', '2016-04-08 02:52:50', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'escuela', 'estudiantes', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2016-03-15 15:40:38', '2016-03-15 16:40:38', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'facturacion', 'clientes', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 66, 132, 281474976710655, 1024, 0, NULL, '2016-04-08 02:37:58', '2016-04-08 02:41:20', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'facturacion', 'detallefactura', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:50:29', '2016-04-08 02:50:29', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'facturacion', 'facturas', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2016-04-08 02:46:19', '2016-04-08 02:46:19', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'facturacion', 'productos', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 44, 88, 281474976710655, 2048, 0, NULL, '2016-04-08 02:26:56', '2016-04-08 02:28:53', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'facturacion', 'usuarios', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 48, 96, 281474976710655, 2048, 0, NULL, '2016-04-08 02:22:26', '2016-04-08 02:24:15', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mydb', 'boleto', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 4194304, NULL, '2016-04-05 10:19:44', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
(NULL, 'mydb', 'camionetas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 4194304, NULL, '2016-04-05 10:19:44', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
(NULL, 'mydb', 'pasajeros', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 4194304, NULL, '2016-04-05 10:19:44', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:32', '2008-11-14 11:31:32', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:34', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 450, 197, 88650, 55450570411999231, 16384, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:34', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 975, 9, 8775, 2533274790395903, 16384, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:34', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 497, 812, 403852, 281474976710655, 20480, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:34', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2008-11-14 11:31:31', '2008-11-14 20:31:32', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2008-11-14 11:31:32', '2008-11-14 20:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 152, 281474976710655, 2048, 48, NULL, '2008-11-14 11:31:31', '2009-03-06 19:08:32', NULL, 'utf8_bin', NULL, '', 'Users and global privileges');
...
(NULL, 'facturacion', 'PRIMARY', 'facturacion', 'detallefactura', 'PRIMARY KEY'),
(NULL, 'facturacion', 'PRIMARY', 'facturacion', 'facturas', 'PRIMARY KEY'),
(NULL, 'facturacion', 'PRIMARY', 'facturacion', 'productos', 'PRIMARY KEY'),
(NULL, 'facturacion', 'PRIMARY', 'facturacion', 'usuarios', 'PRIMARY KEY'),
(NULL, 'mydb', 'PRIMARY', 'mydb', 'boleto', 'PRIMARY KEY'),
(NULL, 'mydb', 'PRIMARY', 'mydb', 'camionetas', 'PRIMARY KEY'),
(NULL, 'mydb', 'fk_Camionetas_Pasajeros1', 'mydb', 'camionetas', 'FOREIGN KEY'),
(NULL, 'mydb', 'PRIMARY', 'mydb', 'pasajeros', 'PRIMARY KEY'),
(NULL, 'mydb', 'fk_Pasajeros_Boleto', 'mydb', 'pasajeros', 'FOREIGN KEY'),
...
CREATE TABLE IF NOT EXISTS `camionetas` (
  `idCamionetas` int(11) NOT NULL,
  `N°_Camioneta` int(11) DEFAULT NULL,
  `Hora_que_paso` time DEFAULT NULL,
  `Num_pasajeros` int(11) DEFAULT NULL,
  `Base_tepos` varchar(20) DEFAULT NULL,
  `Total_pasajeros` int(11) DEFAULT NULL,
  `Paquete` varchar(45) DEFAULT NULL,
  `Taquillera` varchar(45) DEFAULT NULL,
  `Nom_conductor` varchar(45) DEFAULT NULL,
  `Pasajeros_idPasajeros` int(11) NOT NULL,
  `Pasajeros_Boleto_idBoleto` int(11) NOT NULL,
  PRIMARY KEY (`idCamionetas`,`Pasajeros_idPasajeros`,`Pasajeros_Boleto_idBoleto`),
  KEY `fk_Camionetas_Pasajeros1_idx` (`Pasajeros_idPasajeros`,`Pasajeros_Boleto_idBoleto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcar la base de datos para la tabla `camionetas`
--
...
CREATE TABLE IF NOT EXISTS `pasajeros` (
  ...
  `Nombre(s)` varchar(45) DEFAULT NULL,
  `Apellidos` varchar(45) DEFAULT NULL,
  `Boleto_idBoleto` int(11) NOT NULL,
  PRIMARY KEY (`idPasajeros`,`Boleto_idBoleto`),
  KEY `fk_Pasajeros_Boleto_idx` (`Boleto_idBoleto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `camionetas`
  ADD CONSTRAINT `fk_Camionetas_Pasajeros1` FOREIGN KEY (`Pasajeros_idPasajeros`, `Pasajeros_Boleto_idBoleto`) REFERENCES `pasajeros` (`idPasajeros`, `Boleto_idBoleto`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pasajeros`
--
ALTER TABLE `pasajeros`
  ADD CONSTRAINT `fk_Pasajeros_Boleto` FOREIGN KEY (`Boleto_idBoleto`) REFERENCES `boleto` (`idBoleto`) ON DELETE NO ACTION ON UPDATE NO ACTION;
--
-- Base de datos: `mysql`
--
...
--
-- Volcar la base de datos para la tabla `general_log`
--
...
--
-- Volcar la base de datos para la tabla `ndb_binlog_index`
--
...
--
-- Volcar la base de datos para la tabla `plugin`
--
...
--
-- Volcar la base de datos para la tabla `servers`
--
...
--
-- Volcar la base de datos para la tabla `slow_log`
--
